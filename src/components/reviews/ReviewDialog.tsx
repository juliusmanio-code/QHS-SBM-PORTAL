...
export const ReviewDialog: React.FC<ReviewDialogProps> = ({ mov, isOpen, onClose }) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-5">
          ...
          <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs flex items-start justify-between">
